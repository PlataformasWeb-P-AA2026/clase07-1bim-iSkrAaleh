...
#MOdulos asiganados por estudiante
print("---------------------------------------")
for e in estudiantes:
    print(f"Estudiante: {e.nombre} {e.apellido}")
    for m in e.modulos:
        # Agregamos m.periodo al print
        print(" -> Matriculado en el módulo: {m.modulo.nombre} | Periodo: {m.periodo}")
